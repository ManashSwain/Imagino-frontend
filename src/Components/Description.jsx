...
const Description = () => {
  ...
  <p className="mx-auto mt-6 mb-4 max-w-2xl text-pretty text-center text-lg font-medium text-gray-600 sm:text-xl/8">Turn your imaginations into visuals</p>
    ...
    <div className="lg:w-1/2 w-full mb-10 lg:mb-0 rounded-lg overflow-hidden">
      ...
      whileInView={{opacity : 1 , y:0}} alt="feature" className="object-cover object-center h-96 w-full" src="spaceship.jpg"/>
    </div>
    <motion.div
     initial={{opacity:0.4 , y: 200 }}
     transition={{ duration:1}}
     whileInView={{opacity : 1 , y:0}} className="flex flex-col flex-wrap lg:py-6 -mb-10 lg:w-1/2 lg:pl-12 lg:text-left text-center"> 
